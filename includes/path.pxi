...
def copy_file(src_path, dest_path):
	start_new_thread2(shutil.copyfile, args=(src_path, dest_path))

def remove_file(file):
	start_new_thread2(unlink, args=(file,))

def remove_tree(tree):
	start_new_thread2(shutil.rmtree, args=(tree,), kwargs={'ignore_errors': 1})
