...
'''
Modified Cython/Includes/libcpp/vector.pxd with `emplace()` and `emplace_back()`
methods.
See original license @ https://github.com/cython/cython/blob/master/LICENSE.txt
'''
...
cdef extern from '<vector>' namespace 'std' nogil:
  cdef cppclass vector[T,ALLOCATOR=*]:
    ...
    # added methods
    iterator emplace(iterator, ...) except +
